  ...
  module Auth
    class Engine < Rails::Engine
      ...
      def self.backend_available?
        @@backend_available ||= Rails::Engine.subclasses.map{ |e| e.class.to_s }.include?('Spree::Backend::Engine')
      end

      def self.dash_available?
        @@dash_available ||= Rails::Engine.subclasses.map{ |e| e.class.to_s }.include?('Spree::Dash::Engine')
      end

      def self.frontend_available?
        @@frontend_available ||= Rails::Engine.subclasses.map{ |e| e.class.to_s }.include?('Spree::Frontend::Engine')
      end
